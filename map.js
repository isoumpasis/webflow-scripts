  ...
  let nameHtml = `
      ...
      ${
        !markerProps.lovatoServices.lovatoSystems && markerProps.lovatoServices.gogasTanks
          ? '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 52.1 52.11"><path d="M50.67,23.48H31.76v-.04h0c-1.48-3.68-5.65-5.46-9.33-3.99s-5.46,5.65-3.99,9.33,5.65,5.46,9.33,3.99c1.82-.73,3.26-2.17,3.99-3.99h3.11c-1.46,5.4-7.01,8.59-12.41,7.14-5.4-1.46-8.59-7.01-7.14-12.41,1.46-5.4,7.01-8.59,12.41-7.14,2.73,.74,5.02,2.58,6.33,5.08h16.3C47.83,8.03,34.89-.8,21.46,1.74,8.03,4.28-.8,17.22,1.74,30.65c2.54,13.43,15.48,22.26,28.91,19.72,12.65-2.39,21.35-14.07,20.02-26.87v-.02Z" fill="#fff"/></svg>'
